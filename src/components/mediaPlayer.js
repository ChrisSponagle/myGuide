...
// const audio = 'https://my-guide-korea.herokuapp.com/public/audio/Gangyeongjeon.m4a'
const PLAYLIST = [
	new PlaylistItem(
		'Comfort Fit - “Sorry”',
		'https://my-guide-korea.herokuapp.com/public/audio/Gangyeongjeon.m4a',
...
export default class MediaPlayer extends Component {
	...
	async _loadNewPlaybackInstance(playing) {
		...
		const source = { uri: this.props.audio };
		const initialStatus = {
			shouldPlay: playing,
